...
const CarteiraEstudante: React.FC = () => {
  ...
  const applyCardTransform = (rotateX: number, rotateY: number, scale: number = 1) => {
    if (cardRef.current) {
      ...
      card.style.transform = `perspective(1000px) rotateX(${rotateX}deg) rotateY(${baseRotateY + adjustedRotateY}deg) scale(${scale})`;
    }
  };
    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          >
            Mais que um documento, é um passaporte para experiências que vão além da sala de aula. 
            A carteira garante entrada em eventos, descontos em cursos, acesso a conteúdos exclusivos 
            e faz a ponte com empresas, clubes e universidades.
          </motion.p>
        </motion.div>
        ...
        <div className="mb-20">
          <div className="relative max-w-full mx-auto flex justify-center">
            ...
            <div className="perspective-1000">
              <div 
                ref={cardRef}
                className={`relative preserve-3d mx-auto card-container ${isFlipping ? 'flipping' : ''}`}
                style={{ 
              ...
              >
                {/* Frente da carteira */}
                <div 
                  className={`backface-hidden rounded-xl shadow-xl overflow-hidden card-flip-front`}
                >
                  <img 
                ...
                {/* Verso da carteira */}
                <div 
                  className={`backface-hidden rounded-xl shadow-xl overflow-hidden card-flip-back`}
                >
                  <img 
