    ...
    <section className="py-16 bg-gray-50 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            O DNA do Brasil é um programa que acredita na força da <motion.span 
              className="font-bold highlight-text px-1 mx-0.5 inline-block"
              whileHover={{ scale: 1.05 }}
              transition={{ type: "spring", stiffness: 400 }}
            >educação e do esporte</motion.span> para transformar vidas. Atuamos diretamente com escolas públicas e comunidades, levando ferramentas que ajudam estudantes, professores e famílias a descobrirem talentos, superarem desafios e ampliarem suas possibilidades de futuro.
          </motion.p>
        </motion.div>
