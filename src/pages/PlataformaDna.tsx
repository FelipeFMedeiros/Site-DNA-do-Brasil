...
import Tecnologia from '@components/sections/PlataformaDNA/Tecnologia';
import CursosEAD from '@/components/sections/PlataformaDNA/CursosEAD';
import Aplicativo from '@/components/sections/PlataformaDNA/Aplicativo';

const PlataformaDNA: React.FC = () => {
    return (
        <div className="min-h-screen bg-gray-50 overflow-x-hidden">
            ...
            >
                ...
                <div className="max-w-7xl mx-auto relative z-10 mt-8">
                    ...
                    >
                        Descubra um ambiente digital completo para gestão e desenvolvimento de talentos, conectando
                        estudantes, educadores e oportunidades.
                    </motion.p>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">Transforme dados em oportunidades</h2>
                            <p className="text-xl opacity-90 mb-6">
                                A Plataforma DNA do Brasil é o seu espaço digital de crescimento. Aqui, cada passo é
                        ...
                        >
                            <div className="h-72 bg-blue-100 flex items-center justify-center overflow-hidden">
                                <img
                                    src="/images/programa-dna/facts-img.webp"
                                    alt="Plataforma DNA do Brasil em dispositivos"
